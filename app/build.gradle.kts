...
android {
    namespace = "com.hdfc.docupload"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.hdfc.docupload"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
        ...
        // Placeholder base URL for future REST integration.
...
dependencies {
    ...
    // EXIF handling for correct orientation during compression
